...
def J_W1 (x, y) :
    a0, z1, a1, z2, a2, z3, a3 = network_function(x)
    J = 2 * (a3 - y)
    J = J * d_sigma(z3)                    # ∂C/∂a(3) * ∂a(3)/∂z(3)
    J = (J.T @ W3).T                        # (∂C/∂a(3) * ∂a(3)/∂z(3)) * ∂z(3)/∂a(2) * ∂a(2)/∂z(2) * ∂z(2)/∂a(1)
    J = J * d_sigma(z2)                     # (∂C/∂a(3) * ∂a(3)/∂z(3)) * ∂z(3)/∂a(2) * ∂a(2)/∂z(2) * ∂z(2)/∂a(1) * ∂a(1)/∂z(1)
    J = (J.T @ W2).T                         # (∂C/∂a(3) * ∂a(3)/∂z(3)) * ∂z(3)/∂a(2) * ∂a(2)/∂z(2) * ∂z(2)/∂a(1) * ∂a(1)/∂z(1) * ∂z(1)/∂a(0) * ∂a(0)/∂z(1)
    J = J * d_sigma(z1)                     # (∂C/∂a(3) * ∂a(3)/∂z(3)) * ∂z(3)/∂a(2) * ∂a(2)/∂z(2) * ∂z(2)/∂a(1) * ∂a(1)/∂z(1) * ∂z(1)/∂a(0) * ∂a(0)/∂z(1) * ∂z(1)/∂W(1)
    J = J @ a0.T / x.size                  # Average over all training examples
    return J
...
def J_b1 (x, y) :
    ...
    J = (J.T @ W3).T                               # (∂C/∂a(3) * ∂a(3)/∂z(3)) * ∂z(3)/∂a(2) * ∂a(2)/∂z(2) * ∂z(2)/∂a(1)
    J = J * d_sigma(z2)                             # (∂C/∂a(3) * ∂a(3)/∂z(3)) * ∂z(3)/∂a(2) * ∂a(2)/∂z(2) * ∂z(2)/∂a(1) * ∂a(1)/∂z(1)
    J = (J.T @ W2).T                          # (∂C/∂a(3) * ∂a(3)/∂z(3)) * ∂z(3)/∂a(2) * ∂a(2)/∂z(2) * ∂z(2)/∂a(1) * ∂a(1)/∂z(1) * ∂z(1)/∂b(1)
    J= J * d_sigma(z1)
    J = np.sum(J, axis=1, keepdims=True) / x.size    # Average over all training examples
